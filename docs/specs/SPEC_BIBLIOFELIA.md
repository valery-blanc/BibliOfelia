...
#### Fins de ligne — `.gitattributes` (BUG-040)
...
Le message désigne **l'interpréteur**, pas le script — lequel existe et est bien
exécutable. Constaté le 2026-08-26 au remontage de la Box sur carte neuve : 680
fichiers convertis, 5 scripts à shebang, BibliOfelia en boucle de redémarrage
(code 127). Vérification : `head -1 <script> | od -c`.
