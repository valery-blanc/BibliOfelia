...
To reclassify several books into a new category (for example, move
"Youth" books to "Teen"), tick them and choose **Change category**.

### Change location in bulk

If you move an entire aisle to a new location, select the affected
records and use **Change location**. This operation applies to all
copies of the chosen records.
